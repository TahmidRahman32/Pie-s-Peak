...
const Banner = () => {
   return (
      <div className="my-8 bg-banner-img text-center h-[600px] bg-cover bg-center rounded-2xl text-white md:mx-0 mx-2 ">
         <div className="bg-gradient-to-r from-[#150B2Bcc] to-[#150B2B80] h-full space-y-8 md:pt-36 pt-5 rounded-2xl">
            <h1 className="text-5xl font-bold">
               Discover an exceptional cooking <br /> class tailored for you!
            </h1>
            <p className="md:px-56">
